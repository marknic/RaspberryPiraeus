...
# ssh-keygen -f "/home/marknic/.ssh/known_hosts" -R "192.168.1.97"
# sudo ssh-keygen -f "/root/.ssh/known_hosts" -R "192.168.1.97"
# ssh ubuntu@192.168.1.97
# sudo ssh-copy-id -i ~/.ssh/id_rsa.pub ubuntu@192.168.1.97

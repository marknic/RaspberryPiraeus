...
# To run this command:
#  sudo curl -sSL https://raw.githubusercontent.com/marknic/RaspberryPiraeus/master/src/worker/1_worker_install.sh | sh
...
echo "Reboot and then run 2_worker_install.sh"
